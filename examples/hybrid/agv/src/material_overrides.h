...
// (Bulk slider-based helpers — apply_global_xray_neon, apply_visibility,
//  apply_material_rebind, apply_material_restore — were removed during
//  back-to-basics debug cleanup. See git history if you need them back.)

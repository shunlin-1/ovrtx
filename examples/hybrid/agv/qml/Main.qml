...
Window {
    ...
    Item {
        ...
        // (Slider stack removed for back-to-basics debugging. The only
        //  scene controls left are the per-mesh Neon/Xray/Xray-Light
        //  buttons in the bottom-left toolbar above this block.)
